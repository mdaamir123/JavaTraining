...
public class ProductDao {
    ...
    public static boolean doProductsExists() throws DAOLayerException {
        Connection con;
        PreparedStatement stmt = null;
    ...
    public static boolean doProductExists(int id) throws DAOLayerException {
        Connection con;
        PreparedStatement stmt = null;
        ResultSet resultSet = null;
        try {
    ...
    public static Product getProductById(int productId) throws DAOLayerException {
        ...
        try {
            ...
            DatabaseHelperClass.closePreparedStatement(resultSet, preparedStatement);
        }
    }
    ...
    public static boolean doProductSpecificationsExistsForGivenProduct(int id) throws DAOLayerException {
        Connection con;
        PreparedStatement stmt = null;
        ResultSet resultSet = null;
        try {
    ...
    public static boolean doSpecificationExists(int specId, int prdoductId) throws DAOLayerException {
        Connection con;
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        try {
    ...
    public static boolean doProductSpecificationExists(int specId) throws DAOLayerException {
        Connection con;
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        try {
